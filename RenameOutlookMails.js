 ...
 * diese Datei ziehen. Oder besser einen "Senden an"-Eintrag im Explorer zu
 * diesem Skript einrichten. Diese Datei muss nur 1x auf dem PC existieren.
 *
 * Ergebnis:
 * Die E-Mails werden umbenannt und verbleiben dabei im selben Verzeichnis, dem
 ...
 * Ist dies jedoch die gleiche E-Mail, wird sie nicht umbenannt und ein Hinweis
 * ausgegeben.
 */
 ...
 * and rename it according to conventions.
...
function main()
{
	...
	for (var i = 0; i < argv.length; i++) {
		destdir = fso.GetParentFolderName(fso.GetAbsolutePathName(argv(i)));
